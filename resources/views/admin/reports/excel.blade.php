...
<head>
    ...
    <style>
        ...
        .brand h1 { margin: 0 0 2px 0; font-size: 18px; }
        .brand p { margin: 0 0 2px 0; font-size: 11px; }
        .meta { margin: 8px 0; font-size: 11px; }
        table { width: 100%; border-collapse: collapse; margin-top: 8px; }
        th, td { border: 1px solid #cbd5e1; padding: 6px; text-align: left; vertical-align: top; }
        th { background: #e2e8f0; font-size: 11px; }
        .section-title { margin-top: 12px; font-size: 13px; font-weight: 700; }
    </style>
</head>
<body>
        ...
        <tr>
            <td style="border: none; width: 90px;">
                @if(!empty($company['logo_data_uri']))
                    <img src="{{ $company['logo_data_uri'] }}" alt="Company Logo" style="width: 80px; height: auto;">
                @endif
            </td>
